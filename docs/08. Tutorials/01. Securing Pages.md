...
public void Configure(IApplicationBuilder app, IWebHostEnvironment env, IApi api)
{
    ...
    // Custom permissions
    App.Permissions["App"].Add(new Aero.Security.PermissionItem
    {
...
Secondly, let's open up the **Blog Archive** and the first available post "Welcome to Aero CMS". After we've opened the post, let's open it's settings add select our new claim as a requirement to be able to view the post.
