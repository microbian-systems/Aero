...
Now we have a **site type** created with a property called **FooterContents** we can now add fields into it which can be edited in Aero.
...
We have now created our **site type** along with it's footer fields. Now, we want to login to the Aero manager and add some content. To do this, we need to change the **Content Type** of the **Default Site**.

Follow these steps:

1. Login to the Aero manager
