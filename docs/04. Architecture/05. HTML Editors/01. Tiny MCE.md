...
[Tiny MCE](https://www.tiny.cloud) has been the de facto standard for `WYSIWYG` editors for many years and is a very powerful editor. Aero CMS currently supports version `5.0.3` of Tiny MCE and the editor is used in `inline` mode for all editors in the interface.
...
~~~ csharp
PM> install-package Aero.Manager.TinyMCE
~~~
...
public void Configure(IApplicationBuilder app, IApi api)
{
    ...
    Aero.Manager.Editor.EditorConfig.FromFile("editorconfig.json");
...
public void Configure(IApplicationBuilder app, IApi api)
{
    ...
    Aero.Manager.Editor.EditorConfig.Current.Plugins = ...
    Aero.Manager.Editor.EditorConfig.Current.Toolbar = ...
    Aero.Manager.Editor.EditorConfig.Current.BlockFormats = ...
    Aero.Manager.Editor.EditorConfig.Current.StyleFormats =
        new List<Aero.Manager.Editor.EditorStyle>
        {
            ...
        }
