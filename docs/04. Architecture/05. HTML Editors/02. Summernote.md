...
[Summernote](https://summernote.org) is a lightweight editor for editing HTML content in `inline` mode. Aero CMS currently supports version `0.8.11` of Summernote.
...
~~~ csharp
PM> install-package Aero.Manager.Summernote
~~~
