...
~~~ csharp
PM> install-package Aero.Azure.BlobStorage
~~~
...
~~~ csharp
services.AddAeroBlobStorage(credentials);
~~~
...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        services.AddAeroBlobStorage(new StorageCredentials(
...
~~~ csharp
services.AddAeroBlobStorage(myConnectionString);
~~~
...
~~~ csharp
services.AddAeroBlobStorage(credentials, containerName: "dev");
~~~
...
~~~ csharp
services.AddAeroBlobStorage(naming: naming: Aero.Azure.BlobStorageNaming.UniqueFolderNames);
~~~

##### Scope

~~~ csharp
services.AddAeroBlobStorage(credentials, scope: ServiceLifetime.Scoped);
~~~
