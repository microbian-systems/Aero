...
~~~ csharp
PM> install-package Aero.Local.FileStorage
~~~
...
~~~ csharp
services.AddAeroFileStorage(basePath: "wwwroot/media");
~~~
...
~~~ csharp
services.AddAeroFileStorage(basePath: "wwwroot/media", baseUrl: "~/media/");
~~~
...
~~~ csharp
services.AddAeroFileStorage(naming: naming: Aero.Local.FileStorageNaming.UniqueFolderNames);
~~~
...
~~~ csharp
services.AppAeroFileStorage(scope: ServiceLifetime.Scoped);
~~~
