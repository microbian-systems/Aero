...
> This article covers how to implement custom block groups for Aero. If you want to read more about the standard blocks included, please refer to [Blocks](./).
...
The main difference between creating a custom block and a block group is that they inherit from different base classes and uses different attributes for their meta data. All block groups must inherit from the base class `Aero.Extend.BlockGroup`.
