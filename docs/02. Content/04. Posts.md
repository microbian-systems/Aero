...
The preferred way of importing Post types is by using the `Aero.AttributeBuilder` package. With this package you can directly mark your Post models with the Attributes needed.
...
[BlockItemType(typeof(Aero.Extend.Blocks.HtmlBlock))]
